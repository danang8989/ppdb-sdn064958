    ...
    <div class="navbar-wrapper">
      ...
      <div class="navbar-content">
        <ul class="pc-navbar">
          ...
          <li class="pc-item">
            <a href="{{ route('admin.calon_siswa') }}" class="pc-link">
              <span class="pc-micon"><i class="ti ti-user"></i></span>
              <span class="pc-mtext">Calon Pendaftar</span>
            </a>
          </li>
          <li class="pc-item">
            <a href="{{ route('admin.orang_tua') }}" class="pc-link">
              <span class="pc-micon"><i class="ti ti-users"></i></span>
              <span class="pc-mtext">Data Orang Tua</span>
            </a>
          </li>
          <li class="pc-item">
            <a href="{{ route('admin.berkas') }}" class="pc-link">
          ...
          <li class="pc-item">
            <a href="{{ route('admin.jadwal_pendaftaran') }}" class="pc-link">
              <span class="pc-micon"><i class="ti ti-calendar"></i></span>
              <span class="pc-mtext">Jadwal Pendaftaran</span>
            </a>
          </li>
          <li class="pc-item">
            <a href="{{ route('admin.tahun_ajar') }}" class="pc-link">
              <span class="pc-micon"><i class="ti ti-bookmark"></i></span>
              <span class="pc-mtext">Tahun Ajar</span>
            </a>
          </li>
